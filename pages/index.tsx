    ...
    <div className="">
      ...
      <main className="flex flex-col items-center lg:items-end pt-24 max-w-6xl mx-auto lg:relative lg:min-h-[80vh] lg:justify-center">
        <div className="max-w-xs md:max-w-xl text-center lg:text-right">
          ...
          <p className="mt-4 md:text-2xl font-light text-neutrals-0 leading-tight">
        ...
        />
        <Link href="/create">
          <a className="bg-gradient-to-r to-primary-0 from-primary-3 mt-8 text-neutrals-5 font-semibold rounded-xl p-4 flex tracking-wide md:w-80 justify-center md:text-2xl">
            🎉 Create my event
          </a>
        </Link>
      </main>
